...
def convertWords(srcFile, destFile):
	...
	for key in numWordDict.keys():
		reference += key + " : " + str(numWordDict[key]) + "\n"

	writeFile = open(destFile, "w")
	writeFile.write(reference)
	'''
	for key in numWordDict.keys():
		wordList = ""
...
convertWords("/Users/Luke/Desktop/webdev/other/words.txt", "/Users/Luke/Desktop/webdev/other/reference.txt")
